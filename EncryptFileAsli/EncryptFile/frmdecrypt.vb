...
Public Class frmdecrypt
    ...
    Private Sub btnsimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsimpan.Click
        Try          
            ...
            koneksi()
            cmd = New OleDbCommand("insert into tblterima values ('" & txtnosurat.Text & "','" & txttglsurat.Text & "','" & namafile & "')", con)
            cmd.ExecuteNonQuery()
            con.Close()
    ...
    Public Sub tampil()
        Try
            ...
            Else
                cmd = New OleDbCommand("select * from tblterima where nosurat like '%" & txtcari.Text & "%' or tglsurat like '%" & txtcari.Text & "%'", con)
            End If
    ...
    Private Sub ListView1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.Click
        ...
        txttglsurat.Text = ListView1.SelectedItems.Item(0).SubItems(2).Text
        namafile = ListView1.SelectedItems.Item(0).SubItems(3).Text
    ...
    Private Sub btnubah_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnubah.Click
        Try
            ...
            koneksi()
            cmd = New OleDbCommand("update tblterima set nosurat='" & txtnosurat.Text & "',tglsurat='" & txttglsurat.Text & "' where lampiran='" & namafile & "'", con)
            cmd.ExecuteNonQuery()
            con.Close()
